...
public class MailUtil {
    ...
    public void init() {
        this.mailText = "<div style=\"font-family: serif;line-height: 22px;padding: 30px\">\n" +
                ...
                "               href=\"https://n5s.cn\" target=\"_blank\">\n" +
        ...
        // 强制给 JavaMailSenderImpl 设置账号和密码
    ...
    public void sendMailMessage(List<String> to, String subject, String text) {
        ...
        log.info("text：{}", text);
        log.info("加载的配置文件是：{}",mailProperties.toString());

        log.info("mailSender 全字段: {}",
                ReflectionToStringBuilder.toString(mailSender, ToStringStyle.MULTI_LINE_STYLE));
