    ...
    <div class="header-right">
      <div class="admin-index" @click="router.push({ path: '/' })">
        <svg viewBox="0 0 1024 1024" width="25" height="25" style="vertical-align: -6px;">
          ...
          <path
            ...
            fill="#FAD996"></path>
          <path d="M833.4 481l-321.2-270-1.8 1.6V896h278.8c24.8 0 45-20.2 45-45l-0.2-370h-0.6z" fill="#F7C872"></path>
          <path
      ...
      <div class="header-user-con">
        <el-dropdown placement="bottom">
          <el-avatar class="user-avatar" :size="40" :src="store.currentAdmin.avatar">
          </el-avatar>
