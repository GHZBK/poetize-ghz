        ...
        <div class="tree-hole-content"
          ...
          <div class="tree-hole-box"
            ...
            <div class="box-tag" v-if="index % 2 === 0 && !common.mobile()"
              :style="{ 'border-color': 'transparent transparent transparent ' + constant.tree_hole_color[index % constant.tree_hole_color.length] }">
            </div>
            <div class="box-tag" v-if="index % 2 !== 0 || common.mobile()"
              :style="{ 'border-color': 'transparent ' + constant.tree_hole_color[index % constant.tree_hole_color.length] + ' transparent transparent' }">
            </div>
            ...
            <div style="display: flex;justify-content: space-between">
              ...
              <div @click="deleteTreeHole(treeHole.id)" class="tree-hole-delete"
                v-if="!common.isEmpty(store.currentUser) && store.currentUser.id === treeHole.userId">
...
// Emits 定义
const emit = defineEmits(['launch', 'deleteTreeHole'])
...
/**
 * 触发删除树洞事件
 * @param {number|string} id - 树洞的唯一标识
 */
